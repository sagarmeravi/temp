...
const articles = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1546410531-bb4caa6d8aa1?q=80&w=600&h=400&auto=format&fit=crop",
  },
  {
      ...
      <header className="container mx-auto py-6">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-6 text-sm">
            ...
            <Link href="/articles/" className="text-white transition-colors border-b-2 border-blue-500 pb-1">
              Articles
            </Link>
