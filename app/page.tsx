      ...
      <main className="container mx-auto px-4 py-12">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h1 className="text-4xl md:text-6xl font-bold leading-tight">
                Showcasing <span className="text-blue-500">Data Analytics</span> Projects & Insights
              </h1>
              <p className="text-gray-400 text-lg md:text-xl">
                Explore dashboards, case studies, and insights derived from real-world datasets.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button className="bg-blue-600 hover:bg-blue-700">
                  <Link href="/articles/">View Projects</Link>
                </Button>
                <Button
                  variant="outline"
        ...
        <section className="mb-20">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link href="/articles/" className="text-blue-500 hover:text-blue-400 text-sm flex items-center gap-2">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <form onSubmit={handleSubscribe} className="flex gap-2">
              <Input
                ...
                required
              />
              <Button type="submit" className="bg-blue-600 hover:bg-blue-700 whitespace-nowrap" disabled={isSubmitting}>
...
function FeaturedCard({ title, description, image, date, category, icon, slug = "" }) {
  return (
    <Card className="bg-gray-900 border-gray-800 overflow-hidden hover:border-blue-500/50 transition-colors">
